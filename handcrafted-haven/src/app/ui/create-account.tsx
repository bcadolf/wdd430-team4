...
import { createSeller } from "@/app/lib/actions";


export default function CreateSellerForm () {
    const searchParams = useSearchParams();
    const [ state, formAction, isPending] = useActionState(createSeller, undefined);
