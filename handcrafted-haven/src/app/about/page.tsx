  ...
  return (
    <div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.sectionContent}>
            <p className={styles.purpose}>
              Our mission is to connect creative makers and passionate buyers
              through a marketplace built for originality. Whether you&apos;re
              shopping for handcrafted goods, vintage treasures, or
              one-of-a-kind art, we&apos;re here to celebrate individuality and
              small business. Every purchase supports an independent creator —
              not a factory — and helps keep craftsmanship and personal
              expression alive.
            </p>
          </div>
          <section className={styles.section}>
      ...
      <section className={styles.bottomSection}>
        ...
        <button className={styles.button} onClick={handleShop}>
          Shop Now
        </button>
